...
| --- | --- | --- | --- | --- |
| 2   | - Tìm hiểu dịch vụ **AWS CloudWatch** (Logs, Metrics, Alarms, Dashboards) <br> - Cấu hình CloudWatch Agent trên EC2 để đẩy log hệ thống Backend NestJS và Server Web Next.js về CloudWatch Logs | 29/06/2026 | 29/06/2026 | [Tại đây](<https://docs.aws.amazon.com/cloudwatch/>) |
